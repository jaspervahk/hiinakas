/* @ts-self-types="./ofc_nn.d.ts" */

export class MlpModel {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MlpModelFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mlpmodel_free(ptr, 0);
    }
    /**
    ...
    forward(input) {
        ...
        const ret = wasm.mlpmodel_forward(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     ...
     */
    forward_batch(inputs, n) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF32ToWasm0(inputs, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.mlpmodel_forward_batch(retptr, this.__wbg_ptr, ptr0, len0, n);
     ...
     */
    input_dim() {
        const ret = wasm.mlpmodel_input_dim(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    constructor(data) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.mlpmodel_new(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            ...
            this.__wbg_ptr = r0;
            MlpModelFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
     ...
     */
    output_scale() {
        const ret = wasm.mlpmodel_output_scale(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) MlpModel.prototype[Symbol.dispose] = MlpModel.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ofc_nn_bg.js": import0,
    };
}

const MlpModelFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mlpmodel_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ofc_nn_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
